...
export class FillUserTableDao {
  ...
  private readonly userAliasAttribute = "user_alias";
  private readonly userFirstNameAttribute = "user_firstname";
  private readonly userLastNameAttribute = "user_lastname";
  private readonly userImageUrlAttribute = "user_imageUrl";
  //private readonly passwordHashAttribute = "password_hash";
  private readonly followeeCountAttribute = "num_followees";
  private readonly followerCountAttribute = "num_followers";
