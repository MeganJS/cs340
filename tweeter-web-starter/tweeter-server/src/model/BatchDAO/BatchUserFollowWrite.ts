...
import { FillUserTableDao } from "./FillUserTableDAO";
import { FillFollowTableDao } from "./FillFollowTableDAO";
import { FillAuthTableDao } from "./FillAuthTableDAO";
...
const mainUsername = "@d";
const baseFollowerAlias = "@robot";
const followerPassword = "robot";
const followerImageUrl =
  "https://cs340-tweeter-images-247.s3.us-west-2.amazonaws.com/image/%40robot.png";
const baseFollowerFirstName = "robot";
const baseFollowerLastName = "n/a";
...
const fillAuthTableDao = new FillAuthTableDao();
...
async function createUsers(createdUserCount: number) {
  ...
  await fillUserTableDao.createUsers(userList);
  await fillAuthTableDao.createUserAuthItems(userList, followerPassword);
